 ...
 * @version $Id: tpl_checkout_payment_default.php for Datenweitergabe an Transportunternehmen 2022-12-17 14:01:42Z webchills $
 */
?>
...
<?php if (($payment_modules->in_special_checkout()) &&  (isset($_SESSION['paypal_ec_markflow'])) && ($_SESSION['paypal_ec_markflow'] == 1)) {?>
